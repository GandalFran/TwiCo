...
class CovidLocationService:
    ...
    def extract(self, from_date:str=None, to_date:str=None) -> list:
        """
        Extracts covid cases and deaths in Barcelona city, and transforms the given location into the WGS84
        standar (lat, lon).
