...
topics_argument_parser.add_argument('q',
							location='args',
							type=str,
							required=True,
							default=None,
...
topics_argument_parser.add_argument('count_tweets',
							location='args',
							type=int,
							required=False,
							default=None,
...
topics_argument_parser.add_argument('count_news',
							location='args',
							type=int,
							required=False,
							default=None,
...
topics_argument_parser.add_argument('lang',
							location='args',
							type=str,
							required=False,
							default=None,
...
topics_argument_parser.add_argument('from_date',
							location='args',
							type=str,
							required=False,
							default=None,
...
topics_argument_parser.add_argument('to_date',
							location='args',
							type=str,
							required=False,
							default=None,
